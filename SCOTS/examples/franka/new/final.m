...
% --- Configuration ---
csv_filename = 'xyz_roll_pitch_yaw.csv';
...
target_min_pos = [3.6, 3.6, 3.6];
target_size = [0.3, 0.3, 0.3]; 

% --- Obstacle Definition (Requested obstacle for visualization) ---
% Bounds: X-span, Y-span, Z-span = { 1.8, 2.2, 1.8, 2.2, 1.8, 2.2 }
obstacle1_min_pos = [1.8, 1.8, 0.0];
obstacle1_size = [0.4, 0.4, 4.0]; % 2.2 - 1.8

obstacle2_min_pos = [1.0, 1.0, 0.0];
obstacle2_size = [0.2, 2.0, 4.0];

obstacle3_min_pos = [2.8, 1.0, 0.0];
obstacle3_size = [0.2, 2.0, 4.0];

obstacle4_min_pos = [1.2, 2.8, 0.0];
obstacle4_size = [0.8, 0.2, 4.0];

obstacle5_min_pos = [2.0, 1.0, 0.0];
obstacle5_size = [1.0, 0.2, 4.0];
...
xlim([0, 4]); ylim([0, 4]); zlim([0, 4]); % Match state space bounds
hold off;
