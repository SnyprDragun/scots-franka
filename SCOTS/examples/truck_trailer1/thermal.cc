...
auto system_post = [](state_type &x, const input_type &u) noexcept {
   ...
   auto rhs =[](state_type& xx,  const state_type &x, const input_type &u) noexcept {
       xx[0]=(x[1]*4500.000000/5000.000000) + ((x[2]-x[0])*4600.000000/5000.000000) + u[0];
       xx[1]=x[2]-x[1];
       xx[2]=-((x[1])*4500.000000/1000.000000) -((x[2] - x[0])*4600.000000/1000.000000);
     };
...
int main() {
  ...
  state_type eta={{0.05,0.1,0.05}};
 /* lower bounds of the hyper-rectangle */
  state_type lb={{0,-0.6,0}};
  /* upper bounds of the hyper-rectangle */
  state_type ub={{18,0.3,18}};
