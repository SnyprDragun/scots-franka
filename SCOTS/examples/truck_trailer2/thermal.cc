...
auto system_post = [](state_type &x, const input_type &u) noexcept {
   ...
   auto rhs =[](state_type& xx,  const state_type &x, const input_type &u) noexcept {
       xx[0] = (x[1]*14500.000000/5000.000000) + ((x[2]-x[0])*14600.000000/5000.000000) + u[0];
       xx[1] = x[2]-x[0];
       xx[2] = (x[3] - x[1])*14500.000000/1000.000000 + (x[4] -2*x[2] +x[0])*14600.000000/1000.000000;
       xx[3] = x[4]-x[2];
       xx[4] = -((x[3])*14500.000000/1000.000000) -((x[4] - x[2])*14600.000000/1000.000000);
     };
...
int main() {
  ...
  state_type eta={{0.25,0.1,0.25,0.1,0.25}};
 /* lower bounds of the hyper-rectangle */
  state_type lb={{0,-0.5,0,-0.5,0}};
  /* upper bounds of the hyper-rectangle */
  state_type ub={{10,0.3,10,0.3,10}};
